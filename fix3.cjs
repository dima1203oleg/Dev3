...
const startIndex = content.indexOf('{/* TAB 8: Docs & ADRs */}');
if (startIndex === -1) {
    console.log("Could not find TAB 8 start index");
    process.exit(1);
}
...
fs.writeFileSync('src/components/DataIngestionTab.tsx', newContent);
console.log("Success");
