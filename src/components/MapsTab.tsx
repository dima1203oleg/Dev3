  ...
  return (
    <div className="space-y-6" id="maps-tab-root">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-2" id="maps-hud-stats">
        <div className="bg-[#0b1329]/60 border border-white/10 rounded-2xl p-2 flex items-center justify-between shadow-2xl shadow-black/40">
          <div>
          ...
          <div className="p-2.5 rounded-2xl border border-white/10 bg-blue-500/10 text-blue-400">
        ...
        <div className="bg-[#0b1329]/60 border border-white/10 rounded-2xl p-2 flex items-center justify-between shadow-2xl shadow-black/40">
          ...
          <div className="p-2.5 rounded-2xl border border-white/10 bg-amber-500/10 text-amber-400">
        ...
        <div className="bg-[#0b1329]/60 border border-white/10 rounded-2xl p-2 flex items-center justify-between shadow-2xl shadow-black/40">
          ...
          <div className="p-2.5 rounded-2xl border border-white/10 bg-rose-500/10 text-rose-500">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-12 gap-2">
        ...
        <div className="xl:col-span-8 bg-slate-900/40 border border-white/10 rounded-2xl p-2 shadow-2xl relative overflow-hidden backdrop-blur-sm">
          
          {/* Header controls of the Map */}
          <div className="flex flex-col md:flex-row md:items-center justify-between border-b border-white/10 pb-4 gap-2 z-10 relative">
            ...
            {/* Quick Zoom presets */}
            <div className="flex flex-wrap items-center gap-1 bg-slate-950/80 p-1.5 rounded-2xl border border-white/10/60">
              <button
          ...
          <div className="relative h-[440px] bg-slate-950/40 backdrop-blur-md shadow-[0_4px_40px_rgba(30,58,138,0.15)] border border-white/10 rounded-2xl overflow-hidden mt-5 flex items-center justify-center">
            
            {/* Top Indicator Panel inside Map */}
            <div className="absolute top-2 left-3 bg-slate-950/80 border border-white/10 px-3 py-1.5 rounded-2xl text-xs font-mono text-slate-300 z-20 flex items-center gap-2 uppercase">
            ...
            <div className="absolute bottom-3 left-3 bg-slate-950/80 border border-white/10 px-2.5 py-1.5 rounded-2xl text-[8.5px] font-mono text-slate-500 z-20 flex items-center gap-1.5 uppercase select-none">
          ...
          <div className="bg-slate-950/80 rounded-2xl border border-white/10/80 p-2 mt-5 grid grid-cols-2 md:grid-cols-4 gap-2 z-10 relative">
        ...
        <div className="xl:col-span-4 space-y-6">
          ...
          <div className="bg-slate-900/40 border border-white/10 rounded-2xl p-2 shadow-2xl shadow-black/40 space-y-4">
            ...
            <div className="relative">
              <input 
                ...
                className="w-full bg-slate-950/40 backdrop-blur-md shadow-[0_4px_40px_rgba(30,58,138,0.15)] border border-white/10 focus:border-white/10 focus:outline-none rounded-2xl px-2 py-1.5 text-xs text-white placeholder-slate-500 font-sans"
              />
              <Search className="w-4 h-4 text-slate-500 absolute right-3 top-2.5" />
            </div>

            {/* Risk filter select pill box */}
            <div className="flex items-center gap-1 bg-slate-950/60 p-1 rounded-2xl border border-white/10/60 text-xs">
              <button
              ...
              <button
                ...
                className={`flex-1 py-1 px-1.5 rounded-2xl font-bold uppercase transition-all cursor-pointer ${riskFilter === 'high' ? 'bg-rose-500/20 text-rose-400 border border-white/10' : 'text-slate-300'}`}
              >
                Критичні
              </button>
              <button
                onClick={() => setRiskFilter('medium')}
                className={`flex-1 py-1 px-1.5 rounded-2xl font-bold uppercase transition-all cursor-pointer ${riskFilter === 'medium' ? 'bg-amber-500/20 text-amber-400 border border-white/10' : 'text-slate-300'}`}
              >
                Середні
              </button>
            </div>
            ...
            <div className="space-y-2 max-h-[160px] overflow-y-auto custom-scrollbar">
              {filteredLocations.map(loc => {
                const isSelected = selectedEntityId === loc.id;
                const riskColorText = loc.riskScore >= 75 ? 'text-rose-400 bg-rose-500/5 border-white/10' : loc.riskScore >= 50 ? 'text-amber-400 bg-amber-500/5 border-white/10' : 'text-emerald-400 bg-emerald-500/5 border-white/10';
                ...
                return (
                  <div
                    ...
                    className={`p-2.5 rounded-2xl border cursor-pointer transition-all duration-300 flex items-center justify-between ${
                      isSelected 
                        ? 'bg-blue-600/20 border-white/10 shadow' 
                        : 'bg-slate-950/40 border-white/10/60 hover:bg-slate-950/80 hover:border-white/10'
                    }`}
                  >
                    <div className="flex items-center gap-2 overflow-hidden">
                      <div className={`p-1.5 rounded-2xl bg-black/40 backdrop-blur-md border border-white/10 text-slate-300 ${isSelected ? 'text-blue-400' : ''}`}>
          ...
          <div className="bg-slate-900/40 border border-white/10 rounded-2xl p-2 shadow-2xl shadow-black/40 space-y-4 relative overflow-hidden">
            ...
            <div className="flex items-center justify-between border-b border-white/10 pb-2.5">
              ...
              <span className="text-xs bg-slate-950/40 backdrop-blur-md shadow-[0_4px_40px_rgba(30,58,138,0.15)] text-slate-300 border border-white/10 px-2 py-1 rounded font-mono uppercase font-black">
            ...
            <div className="space-y-3">
              <div>
                <h4 className="text-xs font-bold text-slate-100">{selectedEntity.name}</h4>
              ...
              <div className="bg-slate-950/70 p-2 rounded-2xl border border-white/10 space-y-2 text-xs text-slate-300 font-mono">
                ...
                {selectedEntity.phone && (
                  <div className="border-t border-white/10/80 pt-2 flex justify-between">
                ...
                <div className="grid grid-cols-1 gap-1.5 text-xs font-mono">
                  {selectedEntity.relationships.map((rel, idx) => (
                    <div 
                      ...
                      className="bg-slate-950/40 hover:bg-slate-950/80 border border-white/10 hover:border-white/10 p-2 rounded-2xl flex items-center justify-between transition-colors cursor-pointer group"
                    >
                      ...
                      <span className={`text-[8.5px] font-bold uppercase px-1 rounded ${rel.risk === 'HIGH' ? 'text-rose-400 bg-rose-500/5 border border-white/10' : rel.risk === 'MEDIUM' ? 'text-amber-400 bg-amber-500/5 border border-white/10' : 'text-emerald-400 bg-emerald-500/5 border border-white/10'}`}>
                        {rel.type}
                      </span>
                    </div>
                  ))}
          ...
          <div className="bg-slate-900/40 border border-white/10 rounded-2xl p-2 shadow-2xl shadow-black/40 space-y-4">
            ...
            {isScanning ? (
              <div className="bg-slate-950/80 p-2 rounded-2xl border border-white/10 flex flex-col items-center justify-center text-center space-y-2">
              ...
              <button
                ...
                className="w-full py-2.5 bg-slate-950/40 backdrop-blur-md shadow-[0_4px_40px_rgba(30,58,138,0.15)] hover:bg-black/40 backdrop-blur-md text-slate-300 border border-white/10 hover:border-white/10 rounded-2xl text-xs font-mono font-bold uppercase tracking-wider transition-all flex items-center justify-center gap-1.5 cursor-pointer"
              >
