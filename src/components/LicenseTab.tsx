  ...
  return (
    <div className="space-y-6" id="license-tab-root">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-1 bg-slate-900/40 border border-blue-500/10 rounded-xl p-5 space-y-5" id="license-simulator">
          <div className="flex items-center gap-2 border-b border-blue-500/10/80 pb-3">
          ...
          <div className="space-y-4 text-xs">
            ...
            <div className="space-y-1.5">
              ...
              <div className="space-y-2">
                <label className="flex items-start gap-2.5 p-2 bg-slate-950/60 rounded-lg border border-slate-850 cursor-pointer hover:border-blue-500/10">
                  <input
                    type="radio"
            ...
            <div className="space-y-1.5">
              ...
              <div className="grid grid-cols-2 gap-2">
                <button
                  ...
                  className={`py-1.5 px-2 rounded-lg border text-center transition-all ${deploymentModel === 'saas' ? 'bg-blue-500/10 border-blue-500/30 text-indigo-300' : 'bg-slate-950/40 backdrop-blur-md shadow-[0_4px_30px_rgba(0,0,0,0.5)] border-blue-500/10 text-slate-500 hover:text-slate-300'}`}
                >
                  Комерційний SaaS
                </button>
                <button
                  ...
                  className={`py-1.5 px-2 rounded-lg border text-center transition-all ${deploymentModel === 'internal' ? 'bg-blue-500/10 border-blue-500/30 text-indigo-300' : 'bg-slate-950/40 backdrop-blur-md shadow-[0_4px_30px_rgba(0,0,0,0.5)] border-blue-500/10 text-slate-500 hover:text-slate-300'}`}
                >
                  On-Premise (Локально)
                </button>
              </div>
          ...
          <div className={`border rounded-xl p-4 space-y-3 transition-all ${currentRisk.color}`} id="simulation-result-box">
            ...
            <div className="space-y-1.5">
              ...
              <p className="text-[11px] text-slate-300/90 leading-relaxed border-t border-blue-500/10/30 pt-2">
        ...
        <div className="lg:col-span-2 space-y-4">
          ...
          <div className="space-y-4" id="license-cards-container">
            {LICENSE_MATRIX.map((item) => (
              <div
                key={item.license}
                className={`bg-slate-900/30 border rounded-xl p-5 space-y-3 transition-colors ${selectedSourceLicense === item.license ? 'border-blue-500/40 bg-slate-900/50' : 'border-blue-500/10/80 hover:border-slate-700/50'}`}
              >
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-3 text-xs border-y border-blue-500/10/60 py-3 text-slate-300">
                  <div>
                ...
                <div className="space-y-1">
                  <span className="text-[10px] uppercase text-blue-400 font-bold tracking-wide block">Офіційний вердикт та обхід:</span>
                  <p className="text-xs text-slate-300 leading-relaxed bg-slate-950/40 p-3 rounded-lg border border-blue-500/10/40">
                    {item.solution}
                  </p>
                </div>
