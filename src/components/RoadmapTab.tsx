    ...
    <div className="space-y-6" id="roadmap-tab-root">
      ...
      <div className="bg-slate-900/60 border border-blue-500/10 rounded-xl p-6 backdrop-blur-md">
        <h2 className="text-xl font-semibold text-slate-100 flex items-center gap-2 mb-2">
          <Calendar className="w-5 h-5 text-blue-400" id="roadmap-title-icon" />
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
            ...
            {ROADMAP_PHASES.map((phase, idx) => {
              ...
              return (
                <button
                  ...
                  className={`w-full text-left p-4 rounded-xl border transition-all relative overflow-hidden flex flex-col justify-between ${isActive ? 'bg-blue-500/10 border-blue-500/40 shadow-[0_0_15px_rgba(99,102,241,0.05)]' : 'bg-slate-900/40 border-slate-850 hover:border-blue-500/10'}`}
                >
                  {/* Phase top tag */}
        ...
        <div className="lg:col-span-2 space-y-4" id="active-phase-details">
          <div className="bg-slate-900/40 border border-blue-500/10 rounded-2xl p-6 space-y-5">
            <div className="flex items-start justify-between border-b border-blue-500/10 pb-4">
              <div>
            ...
            <div className="space-y-1.5">
              ...
              <p className="text-xs text-slate-300 bg-slate-950/60 p-3.5 rounded-xl border border-blue-500/5 leading-relaxed font-medium">
                {activePhase.focus}
              </p>
            </div>
              ...
              <div className="space-y-2">
                ...
                <div className="space-y-1.5">
                  {activePhase.components.map((comp, idx) => (
                    <div key={idx} className="bg-slate-950/80 border border-blue-500/5 p-2 rounded-lg flex items-center gap-2">
                ...
                <div className="space-y-2" id="milestones-checkboxes">
                  {(milestonesState[activePhase.id] || []).map((m, idx) => (
                    <button
                      ...
                      className="w-full text-left bg-slate-950/40 hover:bg-slate-950/40 backdrop-blur-md shadow-[0_4px_30px_rgba(0,0,0,0.5)] border border-blue-500/5/50 hover:border-blue-500/10 p-2.5 rounded-lg flex items-start gap-2.5 transition-all"
                    >
                      {m.done ? (
            ...
            <div className="border-t border-blue-500/10/80 pt-4 space-y-2">
            ...
            <div className="bg-slate-950/40 backdrop-blur-md shadow-[0_4px_30px_rgba(0,0,0,0.5)] rounded-xl p-3 border border-blue-500/5 flex items-center gap-2 text-xs text-slate-300">
        ...
        <div className="lg:col-span-1 space-y-4">
          <div className="bg-slate-900/40 border border-blue-500/10 rounded-xl p-5 space-y-5" id="ai-gpu-cluster-planner">
            ...
            <div className="space-y-2.5 text-xs">
              ...
              <label className="flex items-center gap-2 p-2 bg-slate-950/60 rounded-lg border border-slate-850 cursor-pointer hover:border-blue-500/10">
                <input
                  type="checkbox"
                  checked={runLlama}
            ...
            <div className="space-y-1 text-xs pt-2 border-t border-blue-500/10/60">
